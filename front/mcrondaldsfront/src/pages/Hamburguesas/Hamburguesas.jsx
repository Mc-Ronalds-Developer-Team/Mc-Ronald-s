...
const Hamburguesas = () => {
    ...
    if (loading) return <div className="combos__container"><h2 style={{ color: "white", textAlign: "center" }}>Cargando Hamburguesas...</h2></div>;
    ...
    return (
        <div className="combos__container">
            ...
            <div className="combos__item grid__menu">
                {productos.length === 0 ? (
                    <p style={{ color: "white", textAlign: "center", width: "100%" }}>No hay hamburguesas disponibles.</p>
                ) : (
                    productos.map(p => (
