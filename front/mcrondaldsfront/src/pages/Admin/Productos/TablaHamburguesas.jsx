...
const TablaHamburguesas = () => {
    ...
    return (
        <div className="admin-content">
            <h1 className="admin-title">Gestión de Hamburguesas</h1>

            <button className="btn-crear" onClick={handleOpenCreate}>+ Crear Hamburguesa</button>
            ...
            <div className="table-container">
                <table className="tabla-productos">
                    ...
                    <tbody>
                        {productos.length === 0 ? (
                            <tr><td colSpan="7" style={{ textAlign: "center", padding: "20px" }}>No hay hamburguesas registradas</td></tr>
                        ) : (
                            productos.map((p) => (
                                <tr key={p.idItem}>
                                    <td>{p.idItem}</td>
...
export default TablaHamburguesas;
